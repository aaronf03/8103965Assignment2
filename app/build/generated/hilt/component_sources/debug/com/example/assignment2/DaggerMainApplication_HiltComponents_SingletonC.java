...
import com.example.assignment2.di.NetworkModule_ProvideApiServiceFactory;
import com.example.assignment2.di.NetworkModule_ProvideLoggingInterceptorFactory;
import com.example.assignment2.di.NetworkModule_ProvideMoshiFactory;
import com.example.assignment2.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.assignment2.di.NetworkModule_ProvideRetrofitFactory;
...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_example_assignment2_ui_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_assignment2_ui_login_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_assignment2_ui_login_LoginViewModel = "com.example.assignment2.ui.login.LoginViewModel";

      static String com_example_assignment2_ui_dashboard_DashboardViewModel = "com.example.assignment2.ui.dashboard.DashboardViewModel";

      @KeepFieldType
      LoginViewModel com_example_assignment2_ui_login_LoginViewModel2;

      @KeepFieldType
      DashboardViewModel com_example_assignment2_ui_dashboard_DashboardViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    private DashboardRepository dashboardRepository() {
      return new DashboardRepository(singletonCImpl.provideApiServiceProvider.get());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_example_assignment2_ui_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_example_assignment2_ui_login_LoginViewModel, ((Provider) loginViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.assignment2.ui.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(viewModelCImpl.dashboardRepository());

          case 1: // com.example.assignment2.ui.login.LoginViewModel 
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.assignment2.data.remote.ApiService 
